    ...
    return ( 
        ...
        <div className="project4-text pt-5">
          <h2 className='text-2xl text-[#4CAF50]'>Metal Geek</h2>
            ...
            <p className='md:text-xl max-w-lg mx-auto pb-5 pt-3'>A full-stack application created using React (front end) and Django (back end) built with a Postgresql database and styled with Tailwind CSS.</p>
            ...
            Select again and it takes you back to the home page.
            <br />
            <br />
