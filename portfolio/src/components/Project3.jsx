...
export default function Project3 () {
    ...
    return ( 
        ...
        <div className="project3-text">
          <h2 className='text-2xl'>The Cocktail Selector</h2>
            <img className='mx-auto flex items-center pt-4 w-300 h-220' src="https://sunbizlocal.com/cc.png"></img>
            ...
            <p className='md:text-xl max-w-lg mx-auto pb-5'>The Cocktail Selector is a website that provides detailed information on a list of different cocktails enabling the user to make an informed decision when choosing a cocktail.
            <br />
            <br />
            ...
            <br />
            <br />
            Search Form - The search form allows the user to select a single or group of cocktails by entering the first few letters in the name of the cocktail into the text input bar. The Start Over button is used to reset the search form or start over.</p>
