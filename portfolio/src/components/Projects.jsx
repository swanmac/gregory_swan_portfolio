...
export default function Projects () {
    return(
        ...
        <p>A true/false trivia game created with JavaScript, HTML, and CSS connected to a third party API.</p>
        ...
        <p>A full-stack application with React (front end) and Django (back end) built with a Postgresql database.</p>
