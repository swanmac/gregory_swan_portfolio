...
export default function Projects () {
    return(
        ...
        <p className='md:text-xl max-w-lg mx-auto pb-5 px-10'>An IOS application Card Game. The application was built with Swift using the SwiftUI.</p>
        ...
        <p className='md:text-xl max-w-lg mx-auto pb-5 px-10'>A ten question true/false trivia game created with JavaScript, HTML5, and CSS connected to a third party API.</p>
        ...
        <p className='md:text-xl max-w-lg mx-auto pb-5 px-10'>An application created using the React framework, JavaScript, HTML5 and CSS, connected to a third party API.</p>
