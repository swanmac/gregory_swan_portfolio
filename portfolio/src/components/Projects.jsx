...
export default function Projects () {
    return(
        ...
        <p className='md:text-xl max-w-lg mx-auto pb-5 px-10'>An application created using the React framework, JavaScript and Tailwind CSS, connected to a third party API.</p>
        <Link to="/project3"><img className='mx-auto flex items-center pt-4 pb-5 w-300 h-220'  src="https://sunbizlocal.com/coct.png" alt="project 3" ></img></Link></div>
